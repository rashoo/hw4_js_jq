	...
	<head>
		...
		<script type="text/javascript">
			...
			function hittest(a, b) {
				...
				var cXs = (aX - bX) * (aX - bX); // Change in x^2
				var cYs = (aY - bY) * (aY - bY); // Change in y^2
			...
			function gameloop()
			{
				...
				var b = bullets.children; // bullets.children = array
